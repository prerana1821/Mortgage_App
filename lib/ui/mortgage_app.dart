                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(" ${ ( _homePrice > 0 && _interest > 0.0)
                        ...
                        _interest, _lengthOfLoan)}" : ""}", style: TextStyle(
                       color: secondaryBackgroundWhite
                    ),)
                  ],
                ),
                          ...
                          children: <Widget>[
                            ...
                            InkWell(
                              ...
                              child: Container(
                                  ...
                                  margin: EdgeInsets.all(10),
                                  decoration: BoxDecoration(
                                      color: secondaryDeepPurple, //Colors.blueGrey.withOpacity(0.2),
                                      borderRadius: BorderRadius.circular(16)
                                  ),
                    ...
                    Column(
                      children: <Widget>[
                        Slider(
                            min: 0.0,
                            max: 10.0,
                            activeColor: Theme.of(context).primaryColorDark , //TODO: Theme this!
                            inactiveColor: Theme.of(context).primaryColor, //Colors.grey, //TODO: Theme this!
                            // divisions: 10,
                            value: _interest,
